...
public class VClassBolaoPDAO extends VClassBolaoDAO {
	...
	public DLista selVClassBolaoByMesa(String strNomeMesa) {
		...
		try {
			...
			String strTableMain = new String("V_CLASSIFICACAO_BOLAO_P");
			...
			Error.setErroInterno(new String("VClassBolaoPDAO.selVClassBolaoByRodada(): " + e.toString()));
